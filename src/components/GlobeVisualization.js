  ...
  const subscribe = async (event) => {
    ...
    try {
      ...
      if (response.status === 200) {
        // setAlertMessage("Please confirm the email in your mailbox in 10 minutes.");
        // setAlertType("notification");
        alert("Please confirm the email in your mailbox in 10 minutes.");
      } else {
        // setAlertMessage("Subscription failed.");
        // setAlertType("notification");
      ...
      <div className="row">
        <div className="col-sm-8">
          <div className="d-flex flex-column align-items-left text-container">
            ...
            interesting articles related to the topics I saw on Medium and books, ideas popped up from conversations, and most importantly---a real human perspective. 
            </h6>
            <div>
